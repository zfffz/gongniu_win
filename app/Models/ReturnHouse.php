...
class ReturnHouse extends Model
{
    ...
    public static function findAvailableNo()
    {
        ...
        \Log::warning('退库单号生成失败');

        return false;
    }

    public function return_house_items()
    {
        return $this->hasMany(Return_house_item::class,'parent_id','id');
    }
