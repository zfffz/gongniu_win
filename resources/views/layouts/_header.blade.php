    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">
                <i class="fa fa-cogs"></i>  基础资料 <span class="caret"></span>
            </a>
            <div class="dropdown-menu">
                <a class="dropdown-item" tabindex="-1" href="#"><i class="fas fa-store-alt"></i> 门店管理</a>
                <a class="dropdown-item" tabindex="-1" href="#"><span class="fa fa-users"></span> 客户车辆</a>
