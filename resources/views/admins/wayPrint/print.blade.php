        ...
        <style>table,th{border:none;height:18px} td{border: 1px solid #000;height:18px}</style>    
            <div class="card-body">
                 ...
                 <table class="table table-hover table-bordered" style="width: 100%;border: 1px solid black">
                        <tbody> 
                            <tr>
                                <th style="font-family:黑体; font-size:11pt">序号</th>
                                <th style="font-family:黑体; font-size:11pt">来源单号</th>
                                <!-- <th style="font-family:黑体; font-size:11pt">发货日期</th>
                                <th style="font-family:黑体; font-size:11pt">订单号</th> -->
                                <th style="font-family:黑体; font-size:11pt">客户简称</th>
                                <th style="font-family:黑体; font-size:11pt">客户编码</th>
                                <th style="font-family:黑体; font-size:11pt">发货地址</th>
                                <th style="font-family:黑体; font-size:11pt">结算方式</th>
                                <th style="font-family:黑体; font-size:11pt">金额</th>
                                <th style="font-family:黑体; font-size:11pt">表体备注</th>
                            </tr>
                            @foreach ($data[1] as $dats)
                                <tr>
                                    <td width="5%" style="font-family:黑体; font-size:11pt">{{ $dats->ROWNU }}</td>
                                    <td width="10%" style="font-family:黑体; font-size:11pt">{{ $dats->csocode }}</td>
                               <!--      <td width="10%" style="font-family:黑体; font-size:11pt">{{ $dats->ddate }}</td>
                                    ...
                                    <td width="18%" style="font-family:黑体; font-size:11pt">{{ $dats->ccusabbname }}</td>
                                    <td width="8%" style="font-family:黑体; font-size:11pt">{{ $dats->ccuscode }}</td>
                                    <td width="32%" style="font-family:黑体; font-size:11pt">{{ $dats->cshipaddress }}</td>
                                <!--     <td width="30%" style="font-family:黑体; font-size:11pt">{{ $dats->ccusabbname }}</td> -->
                                    <td width="8%" style="font-family:黑体; font-size:11pt">{{ $dats->cSSName }}</td>
                                    <td width="8%" style="font-family:黑体; font-size:11pt">{{ $dats->amount*1 }}</td>
                                    <td width="11%" style="font-family:黑体; font-size:11pt">{{ $dats->bz }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                </table>
...
$('#btn-submit').on('click', function(){
        ...
        LODOP.ADD_PRINT_HTM(5, 5, '97%', '93%',strBodyStyle+"<body>"+document.getElementById("card").innerHTML+"</body>");
