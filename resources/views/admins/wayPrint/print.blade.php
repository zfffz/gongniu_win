                 ...
                 <table class="table table-hover table-bordered" style="width: 100%;line-height:0.2pt;border: 1px solid black; word-break:break-all">
                        <tbody> 
                            ...
                            @foreach ($data[1] as $dats)
                                <tr>
                                    <td width="4.8%" style="font-family:黑体; font-size:10pt;line-height:3pt;word-wrap: break-word;">{{ $dats->ROWNU }}</td>
                                    <td width="9.5%" style="font-family:黑体; font-size:10pt;line-height:3pt;word-wrap: break-word;">{{ $dats->csocode }}</td>
                               <!--      <td width="10%" style="font-family:黑体; font-size:11pt">{{ $dats->ddate }}</td>
                                ...
                                <!--     <td width="30%" style="font-family:黑体; font-size:11pt">{{ $dats->ccusabbname }}</td> -->
                                    <td width="7.2%" style="font-family:黑体; font-size:10pt;line-height:3pt;word-wrap: break-word;">{{ $dats->cSSName }}</td>
